local config = { 
	...
	["announce"] = { 
		k = "announce",
		value = "当日区第二天下午16点整开始合区\\n首次合区和每周1、3、6攻沙\\n22点整结束。沙巴克奖励领取时间为\\n22：1分至22：10分，过时则无法领取\\n玩家等级必须大于430级",
		notice = "默认公告",
	},
	["GUILD_EXIT_CD"] = { 
		k = "GUILD_EXIT_CD",
	...
	["EXPcoordinate"] = { 
		k = "EXPcoordinate",
		value = "10#450|230#450|250#0|500",
	...
	["ShowBuffList"] = { 
		k = "ShowBuffList",
		value = "101#272#-140#330#50#9#2#4#0#0#0#0#20000#20000#30*30|101#240#-105#330#50#9#2#4#0#0#0#0#20000#20000#30*30",
		notice = "是否显示buff.xls表对应图标配置",
	},
	["UseNewHitDmgType"] = { 
		k = "UseNewHitDmgType",
		value = 1,
		notice = "是否开启ATT表支持战士隔位技能伤害",
	},
	["showFewHp"] = { 
		k = "showFewHp",
		value = 0,
	...
	["monster_hp_count"] = { 
		k = "monster_hp_count",
		value = 100000000,
		notice = "怪物多少血量为一条大血条为空时，所有怪物大血条都为一条血",
	},
	["LimitJYHShowItemCnt"] = { 
		k = "LimitJYHShowItemCnt",
		value = 1,
		notice = "限制交易行数据提交(定制功能)",
	},
	["Texture2DAntialiasEnabled"] = { 
		k = "Texture2DAntialiasEnabled",
		value = 1,
		notice = "PC端抗锯齿模式（0为不开启，1为开启，默认为0）推荐设置为：1  ",
	},
	["PCFontConfig"] = { 
		k = "PCFontConfig",
		value = "1#13",
		notice = "PC端及面板支持宋体并可统一设置PC字体大小  字体#大小(字体：1黑体 2宋体   大小：0默认 大于0为字体大小)",
	},
	["pc_tips_attr_alignment"] = { 
		k = "pc_tips_attr_alignment",
		value = 60,
		notice = "属性名称跟数值的间距推荐设置为：60  ",
	},
	["setTipsFontSizeVspace"] = { 
		k = "setTipsFontSizeVspace",
		value = "16#1|12#4",
		notice = "配置TIPS的名称、备注的字体大小和上下行间隔（移动端字体大小#间隔|PC端字体大小#间隔）推荐设置为：16#1|12#4",
	},
	["CHATCDS"] = { 
		k = "CHATCDS",
		value = "1|10|1|1|1|1|1|1|1",
		notice = "聊天框发送间隔秒数:系统|喊话|私聊|行会|组队|世界|国家|联盟（其中喊话M2-参数设置-信息控制-喊话间隔上可以设置）",
	},
	["MobileChannelNotShow"] = { 
		k = "MobileChannelNotShow",
		value = 8,
		notice = "手机端隐藏频道配置:1=系统2=喊话3=私聊4=行会5=组队6=附近7=世界8=国家9=联盟(#分隔 频道id#频道id)隐藏系统,私聊,组队频道示例: 1#3#5",
	},
	["show_equip_mask"] = { 
		k = "show_equip_mask",
		value = 1,
		notice = "无法穿戴的装备显示一层红色遮罩(1=开启遮罩) ",
	},
	["monster_force_show_hp"] = { 
		k = "monster_force_show_hp",
		value = 0,
		notice = "PC端鼠标移至怪物身上是否显示血量开关(1=开启)",
	},
	["newSetup"] = { 
		k = "newSetup",
		value = 0,
	...
	["CancelDefaultMiniMap"] = { 
		k = "CancelDefaultMiniMap",
		value = 0,
		notice = "无小地图时是否显示默认(默认为显示一张黑底地图)  （0为显示，1不显示，默认为0）",
	},
	["PushIntervalTime"] = { 
		k = "PushIntervalTime",
		value = 230,
		notice = "野蛮类推动速度设置(间隔速度：建议设置方式:M2跑步速度除2)",
	},
	["BagSUILoadDelay"] = { 
		k = "BagSUILoadDelay",
		value = 0,
		notice = "背包自定义按钮自动适配偏移配置 设置为1位开启",
	},
	["dark"] = { 
		k = "dark",
		value = 0,
		notice = "黑夜系统 设置为1=开启,关联M2-假人设置-关照系统勾选禁止免蜡烛-地图参数填dark",
	},
}
return config

...
function JumpAreaManager.ShowBasePanel(actor)
    local strPanelInfo = '<Img|id=10|children={11,12,13,14,15}|x='..CSS.BASE_PANEL_START_X..'|y='..CSS.BASE_PANEL_START_Y..'|reset=1|img=private/cc_jumparea/14.png|show=0|esc=1|move=0|bg=1|loadDelay=0>'..

...
SoulStoneManager.SLOT_CFG_INFO = {
    [SoulStoneManager.SLOT_ID.SLOT_RED_1] = {id = SoulStoneManager.SLOT_ID.SLOT_RED_1, name = '红', shape = SoulStoneManager.STONE_SHAPE.RED, color = CSS.QUALITY_RED},
    [SoulStoneManager.SLOT_ID.SLOT_RED_2] = {id = SoulStoneManager.SLOT_ID.SLOT_RED_2, name = '红', shape = SoulStoneManager.STONE_SHAPE.RED, color = CSS.QUALITY_RED},
    [SoulStoneManager.SLOT_ID.SLOT_RED_3] = {id = SoulStoneManager.SLOT_ID.SLOT_RED_3, name = '红', shape = SoulStoneManager.STONE_SHAPE.RED, color = CSS.QUALITY_RED},
    [SoulStoneManager.SLOT_ID.SLOT_BLUE_1] = {id = SoulStoneManager.SLOT_ID.SLOT_BLUE_1, name = '蓝', shape = SoulStoneManager.STONE_SHAPE.BLUE, color = CSS.QUALITY_BLUE},
    [SoulStoneManager.SLOT_ID.SLOT_BLUE_2] = {id = SoulStoneManager.SLOT_ID.SLOT_BLUE_2, name = '蓝', shape = SoulStoneManager.STONE_SHAPE.BLUE, color = CSS.QUALITY_BLUE},
    [SoulStoneManager.SLOT_ID.SLOT_GREEN_1] = {id = SoulStoneManager.SLOT_ID.SLOT_GREEN_1, name = '绿', shape = SoulStoneManager.STONE_SHAPE.GREEN, color = CSS.QUALITY_GREEN},
    [SoulStoneManager.SLOT_ID.SLOT_GREEN_2] = {id = SoulStoneManager.SLOT_ID.SLOT_GREEN_2, name = '绿', shape = SoulStoneManager.STONE_SHAPE.GREEN, color = CSS.QUALITY_GREEN},
    [SoulStoneManager.SLOT_ID.SLOT_YELLOW_1] = {id = SoulStoneManager.SLOT_ID.SLOT_YELLOW_1, name = '黄', shape = SoulStoneManager.STONE_SHAPE.YELLOW, color = CSS.QUALITY_ORANGE},
    [SoulStoneManager.SLOT_ID.SLOT_YELLOW_2] = {id = SoulStoneManager.SLOT_ID.SLOT_YELLOW_2, name = '黄', shape = SoulStoneManager.STONE_SHAPE.YELLOW, color = CSS.QUALITY_ORANGE},
    [SoulStoneManager.SLOT_ID.SLOT_YELLOW_3] = {id = SoulStoneManager.SLOT_ID.SLOT_YELLOW_3, name = '黄', shape = SoulStoneManager.STONE_SHAPE.YELLOW, color = CSS.QUALITY_ORANGE},    
}

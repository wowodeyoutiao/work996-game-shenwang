...
function EverydayTask.ShowActivityPanel(actor)
    ...
    if nFinalRewardIdx == 0 then
        if nCurrFinishedTaskNum >= nTargTaskNum1 then
            strPanelInfo = strPanelInfo..'<Button|id=31|x=570.0|y=79.0|mimg=private/cc_everyday_task/4.png|nimg=private/cc_everyday_task/4.png|link=@function_button,'..EVERYDAYTASK_BUTTONFUNC_ID_3..'>'
    ...
    for seq, key in ipairs(keys) do
        ...
        elseif status == TASK_STATUS_NOT_FINISH then
            strPanelInfo = strPanelInfo..'<Button|id='..(baseid+4)..'|x=510.0|y=25.0|mimg=private/cc_everyday_task/3.png|nimg=private/cc_everyday_task/3.png|link=@function_button,'..
                EVERYDAYTASK_BUTTONFUNC_ID_2..','..value.id..'>'
        elseif status == TASK_STATUS_FINISHED then
            strPanelInfo = strPanelInfo..'<Button|id='..(baseid+4)..'|x=510.0|y=25.0|mimg=private/cc_everyday_task/4.png|nimg=private/cc_everyday_task/4.png|link=@function_button,'..

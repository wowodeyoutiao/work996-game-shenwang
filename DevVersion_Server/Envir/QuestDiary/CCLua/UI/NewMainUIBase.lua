...
local UI_ICON_POSSTRENGTH = '1'     --槽位强化
local UI_ICON_POSSTAR = '2'         --槽位升星
local UI_ICON_BAOZHU = '3'          --灵玉
local UI_ICON_SOULSTONE = '4'       --魂石
local UI_ICON_GUANZHI = '5'         --官职
local UI_ICON_HUWEI = '6'           --护卫
local UI_ICON_SKILL = '7'           --技能
local UI_ICON_COMPOSE = '8'         --合成


function NewMainUIBase.InitUI(actor)
    addbutton(actor, 109, 11, '<Button|x=92|y=170|mimg=private/cc_functionicon/icon_posstrength.png|nimg=private/cc_functionicon/icon_posstrength.png|link=@newmainuibase_openpanel#sid='..UI_ICON_POSSTRENGTH..'>')        
    addbutton(actor, 109, 12, '<Button|x=92|y=240|mimg=private/cc_functionicon/icon_posstar.png|nimg=private/cc_functionicon/icon_posstar.png|link=@newmainuibase_openpanel#sid='..UI_ICON_POSSTAR..'>')
    addbutton(actor, 109, 13, '<Button|x=22|y=30|mimg=private/cc_functionicon/icon_baozhu.png|nimg=private/cc_functionicon/icon_baozhu.png|link=@newmainuibase_openpanel#sid='..UI_ICON_BAOZHU..'>')        
    addbutton(actor, 109, 14, '<Button|x=22|y=100|mimg=private/cc_functionicon/icon_soulstone.png|nimg=private/cc_functionicon/icon_soulstone.png|link=@newmainuibase_openpanel#sid='..UI_ICON_SOULSTONE..'>')
    addbutton(actor, 109, 15, '<Button|x=22|y=170|mimg=private/cc_functionicon/icon_guanzhi.png|nimg=private/cc_functionicon/icon_guanzhi.png|link=@newmainuibase_openpanel#sid='..UI_ICON_GUANZHI..'>') 
    addbutton(actor, 109, 16, '<Button|x=22|y=240|mimg=private/cc_functionicon/icon_huwei.png|nimg=private/cc_functionicon/icon_huwei.png|link=@newmainuibase_openpanel#sid='..UI_ICON_HUWEI..'>')
    addbutton(actor, 109, 17, '<Button|x=-52|y=30|mimg=private/cc_functionicon/icon_skill.png|nimg=private/cc_functionicon/icon_skill.png|link=@newmainuibase_openpanel#sid='..UI_ICON_SKILL..'>')
    addbutton(actor, 109, 18, '<Button|x=-52|y=100|mimg=private/cc_functionicon/icon_compose.png|nimg=private/cc_functionicon/icon_compose.png|link=@newmainuibase_openpanel#sid='..UI_ICON_COMPOSE..'>')
end
...
function NewMainUIBase.OpenPanel(actor, sid)
    ...
    if sid == UI_ICON_POSSTRENGTH then        
    ...
    elseif sid == UI_ICON_POSSTAR then
